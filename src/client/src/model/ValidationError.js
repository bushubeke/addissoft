...
class ValidationError {
     ...
     * @param loc {Array.<module:model/AnyOfstringinteger>} 
     * @param msg {String} 
     * @param type {String} 
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('loc')) {
                obj['loc'] = ApiClient.convertToType(data['loc'], [AnyOfstringinteger]);
            }
...
/**
 * @member {Array.<module:model/AnyOfstringinteger>} loc
 */
